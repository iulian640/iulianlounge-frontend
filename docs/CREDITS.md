...
Los ficheros viven en `public/models/`. Al añadir un asset nuevo: apuntar aquí
autor, licencia y fuente. Solo se aceptan CC0 y CC-BY (CC-BY exige la línea de
crédito de esta tabla).

## Kits (CC0)

| Asset | Autor | Licencia | Fuente |
|---|---|---|---|
| Furniture Kit (perchero y otros) | [Kenney](https://kenney.nl) | CC0 | [kenney.nl/assets/furniture-kit](https://kenney.nl/assets/furniture-kit) |

## Piezas sueltas (vía [Poly Pizza](https://poly.pizza))

| Asset | Autor | Licencia | Fuente |
|---|---|---|---|
| Armchair (chesterfield) | jeremy | CC-BY 3.0 | [poly.pizza/m/bssBNm9rp8Q](https://poly.pizza/m/bssBNm9rp8Q) |
...
| Asset | Autor | Licencia | Fuente |
|---|---|---|---|
| Helvetiker (typeface.json) | three.js | MIT | [github.com/mrdoob/three.js](https://github.com/mrdoob/three.js/tree/dev/examples/fonts) |
